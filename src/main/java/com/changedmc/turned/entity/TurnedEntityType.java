...
public class TurnedEntityType {
    ...
    public static final RegistryObject<EntityType<DarkLatexMaleEntity>> DARK_LATEX_MALE = ENTITY_TYPES.register("dark_latex_male", () -> EntityType.Builder.of(DarkLatexMaleEntity::new, EntityClassification.CREATURE).sized(1.0f, 1.0f).build(new ResourceLocation(Reference.MOD_ID, "dark_latex_male").toString()));


    public static final RegistryObject<EntityType<DarkLatexSnowLeopardEntity>> DARK_LATEX_SNOW_LEOPARD = ENTITY_TYPES.register("dark_latex_snow_leopard", () -> EntityType.Builder.of(DarkLatexSnowLeopardEntity::new, EntityClassification.CREATURE).sized(1.0f, 1.0f).build(new ResourceLocation(Reference.MOD_ID, "dark_latex_snow_leopard").toString()));
}