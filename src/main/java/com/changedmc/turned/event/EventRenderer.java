...
public class EventRenderer {
    ...
    private static final ResourceLocation ENDER_DRAGON_BOOBA = new ResourceLocation(Reference.MOD_ID, "textures/gui/enderdragon_booba.png");
    ...
    public static void onRenderGameOverlay(RenderGameOverlayEvent.Pre event) {
        ...
        ////////////////////////
        if (TurnedClientConfig.enderDragonBooba.get() && !Minecraft.getInstance().options.hideGui) {
            RenderSystem.setShaderTexture(0, ENDER_DRAGON_BOOBA);
            GuiComponent.blit(
