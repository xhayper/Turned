...
public class TurnedEntityType {
    ...
    public static final RegistryObject<EntityType<ScientistEntity>> SCIENTIST = ENTITY_TYPES.register("scientist", () -> EntityType.Builder.of(ScientistEntity::new, EntityClassification.CREATURE).sized(1.0f, 2.0f).build(new ResourceLocation(Reference.MOD_ID, "scientist").toString()));
}