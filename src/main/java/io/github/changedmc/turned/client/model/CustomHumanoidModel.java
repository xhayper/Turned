package io.github.changedmc.turned.client.model;
...
@OnlyIn(Dist.CLIENT)
public class CustomHumanoidModel<T extends LivingEntity> extends AgeableListModel<T> implements ArmedModel, HeadedModel {
    ...
    public CustomHumanoidModel(ModelPart pRoot) {
    ...
    public CustomHumanoidModel(Function<ResourceLocation, RenderType> pRenderType, ModelPart pHead, ModelPart pBody, ModelPart pLeftArm, ModelPart pRightArm, ModelPart pLeftLeg, ModelPart pRightLeg) {
        ...
        this.head = pHead;
        this.body = pBody;
        this.rightArm = pRightArm;
        this.leftArm = pLeftArm;
        this.rightLeg = pRightLeg;
        this.leftLeg = pLeftLeg;
    }
    ...
    private void poseRightArm(T pLivingEntity) {
        switch (this.rightArmPose) {
            ...
            case CROSSBOW_CHARGE -> AnimationUtils.animateCrossbowCharge(this.rightArm, this.leftArm, pLivingEntity, true);
    ...
    private void poseLeftArm(T pLivingEntity) {
        switch (this.leftArmPose) {
            ...
            case CROSSBOW_CHARGE -> AnimationUtils.animateCrossbowCharge(this.rightArm, this.leftArm, pLivingEntity, false);
