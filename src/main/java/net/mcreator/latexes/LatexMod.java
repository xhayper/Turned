 ...
 *
 *    Keep the LatexModElements object in this class and all calls to this object
...
public class LatexMod {
	...
	public LatexModElements elements;
	public LatexMod() {
		elements = new LatexModElements();
		FMLJavaModLoadingContext.get().getModEventBus().register(this);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::init);
		FMLJavaModLoadingContext.get().getModEventBus().addListener(this::clientLoad);
		MinecraftForge.EVENT_BUS.register(new LatexModFMLBusEvents(this));
	}
	...
	private static class LatexModFMLBusEvents {
		private final LatexMod parent;
		LatexModFMLBusEvents(LatexMod parent) {
			this.parent = parent;
		}
