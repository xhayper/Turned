	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				LatexMod.LOGGER.warn("Failed to load dependency entity for procedure DarkLatexSpiderQueenThisEntityKillsAnotherOne!");
			return false;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				LatexMod.LOGGER.warn("Failed to load dependency sourceentity for procedure DarkLatexSpiderQueenThisEntityKillsAnotherOne!");
			return false;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				LatexMod.LOGGER.warn("Failed to load dependency x for procedure DarkLatexSpiderQueenThisEntityKillsAnotherOne!");
			return false;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				LatexMod.LOGGER.warn("Failed to load dependency y for procedure DarkLatexSpiderQueenThisEntityKillsAnotherOne!");
			return false;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				LatexMod.LOGGER.warn("Failed to load dependency z for procedure DarkLatexSpiderQueenThisEntityKillsAnotherOne!");
			return false;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				LatexMod.LOGGER.warn("Failed to load dependency world for procedure DarkLatexSpiderQueenThisEntityKillsAnotherOne!");
			return false;
		}
		...
		if (((world.getWorldInfo().getGameRulesInstance().getBoolean(DarkLatexTransfurGameRule.gamerule)) == (true))) {
			if (((((((entity instanceof LivingEntity)
				...
				if (((entity instanceof DarklatexEntity.CustomEntity) || (entity instanceof HertxEntity.CustomEntity))) {
					...
					if ((Math.random() < 0.4)) {
						...
						new Object() {
							...
							private void run() {
								...
								if ((Math.random() < 0.5)) {
									if (world instanceof World && !world.isRemote()) {
										ItemEntity entityToSpawn = new ItemEntity((World) world, x, y, z, new ItemStack(Blocks.COBWEB));
				...
				} else if ((((entity instanceof BeeEntity) == (true)) || ((entity instanceof DLbeeEntity.CustomEntity) == (true)))) {
					if (!entity.world.isRemote())
						entity.remove();
					if (world instanceof World && !world.isRemote()) {
						((World) world).playSound(null, new BlockPos((int) x, (int) y, (int) z),
					...
					if (((Math.random() < 0.2) && ((entity instanceof PlayerEntity) != (true)))) {
						if (!entity.world.isRemote())
							entity.remove();
						if (world instanceof World && !world.isRemote()) {
							((World) world).playSound(null, new BlockPos((int) x, (int) y, (int) z),
