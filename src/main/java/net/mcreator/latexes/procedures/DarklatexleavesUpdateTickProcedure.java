	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				LatexMod.LOGGER.warn("Failed to load dependency x for procedure DarklatexleavesUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				LatexMod.LOGGER.warn("Failed to load dependency y for procedure DarklatexleavesUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				LatexMod.LOGGER.warn("Failed to load dependency z for procedure DarklatexleavesUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				LatexMod.LOGGER.warn("Failed to load dependency world for procedure DarklatexleavesUpdateTick!");
			return;
		}
		...
		if (((Math.random() * 100) < (world.getWorldInfo().getGameRulesInstance().getInt(DarklatexspreadspeedGameRule.gamerule)))) {
			...
			if (((world.getBlockState(new BlockPos((int) (x + 1), (int) (y + 0), (int) (z + 0)))).getBlock() == Blocks.OAK_LOG)) {
				{
					BlockPos _bp = new BlockPos((int) (x + 1), (int) y, (int) z);
			...
			} else if (((world.getBlockState(new BlockPos((int) (x - 1), (int) (y + 0), (int) (z + 0)))).getBlock() == Blocks.OAK_LOG)) {
				{
					BlockPos _bp = new BlockPos((int) (x - 1), (int) y, (int) z);
					BlockState _bs = DarklatexlogBlock.block.getDefaultState();
					BlockState _bso = world.getBlockState(_bp);
			...
			} else if (((world.getBlockState(new BlockPos((int) (x + 0), (int) (y + 0), (int) (z + 1)))).getBlock() == Blocks.OAK_LOG)) {
				{
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) (z + 1));
					BlockState _bs = DarklatexlogBlock.block.getDefaultState();
					BlockState _bso = world.getBlockState(_bp);
