...
package net.mcreator.latexes.world.structure;
...
public class Emergencyeviloutpost2Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, NoFeatureConfig config) {
					...
					if ((random.nextInt(1000000) + 1) <= 575) {
						...
						for (int a = 0; a < count; a++) {
							...
							int y = spawnTo.getY();
							int z = spawnTo.getZ();
							if (!CheckevilraidProcedure.executeProcedure(ImmutableMap.of("world", world)))
								continue;
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("latex", "evil_emergency_outpost_2"));
							if (template == null)
								return false;
									...
									random);
							{
								...
								EmergencyeviloutpostOnStructureInstanceGeneratedProcedure.executeProcedure($_dependencies);
							}
						}
					}
					return true;
			...
			event.getRegistry().register(feature.setRegistryName("emergencyeviloutpost_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("latex:emergencyeviloutpost_2"), configuredFeature);
		}
	}
	@SubscribeEvent
