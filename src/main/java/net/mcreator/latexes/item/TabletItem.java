...
public class TabletItem extends LatexModElements.ModElement {
	@ObjectHolder("latex:tablet")
	public static final Item block = null;
	public TabletItem(LatexModElements instance) {
		super(instance, 43);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				TabletRightClickedInAirProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
	}
