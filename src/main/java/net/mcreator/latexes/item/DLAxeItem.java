...
public class DLAxeItem extends LatexModElements.ModElement {
	@ObjectHolder("latex:dl_axe")
	public static final Item block = null;
	public DLAxeItem(LatexModElements instance) {
		super(instance, 59);
	}
	...
	public void initElements() {
		...
		}, 1, -2.5f, new Item.Properties().group(LatexitemsItemGroup.tab)) {
			@Override
