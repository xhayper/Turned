...
public class SyringeItem extends LatexModElements.ModElement {
	@ObjectHolder("latex:syringe")
	public static final Item block = null;
	public SyringeItem(LatexModElements instance) {
		super(instance, 56);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				SyringeRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
