...
public class DLPickaxeItem extends LatexModElements.ModElement {
	@ObjectHolder("latex:dl_pickaxe")
	public static final Item block = null;
	public DLPickaxeItem(LatexModElements instance) {
		super(instance, 60);
	}
