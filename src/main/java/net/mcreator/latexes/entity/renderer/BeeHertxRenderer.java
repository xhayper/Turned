...
@OnlyIn(Dist.CLIENT)
public class BeeHertxRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BeeHertxEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelbee_hertx_model(), 0.6f) {
					{
