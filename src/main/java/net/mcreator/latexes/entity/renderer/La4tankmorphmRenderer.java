...
@OnlyIn(Dist.CLIENT)
public class La4tankmorphmRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(La4tankmorphmEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modella_4_tankmorph_model_m(), 1.0999999999999999f) {
					{
	...
	public static class Modella_4_tankmorph_model_m extends EntityModel<Entity> {
		...
		public Modella_4_tankmorph_model_m() {
			textureWidth = 128;
			textureHeight = 128;
			...
			Cannon.setRotationPoint(0.0F, -33.0F, 0.0F);
			...
			LeftArm.setRotationPoint(-9.0F, -30.0F, 0.0F);
			LeftArm.setTextureOffset(95, 48).addBox(-6.45F, -4.75F, -2.0F, 4.0F, 2.0F, 5.0F, 0.0F, false);
			LeftArm.setTextureOffset(84, 84).addBox(-6.45F, -2.75F, -2.0F, 6.0F, 12.0F, 5.0F, 0.0F, false);
			LeftArm.setTextureOffset(88, 75).addBox(-5.95F, 8.25F, -2.5F, 6.0F, 1.0F, 6.0F, 0.0F, false);
			LeftArm.setTextureOffset(0, 70).addBox(-6.95F, 9.25F, -2.5F, 7.0F, 17.0F, 6.0F, 0.0F, false);
			RightArm = new ModelRenderer(this);
			RightArm.setRotationPoint(9.0F, -30.0F, 0.0F);
			RightArm.setTextureOffset(84, 0).addBox(0.45F, -2.75F, -2.0F, 6.0F, 12.0F, 5.0F, 0.0F, false);
			RightArm.setTextureOffset(101, 82).addBox(2.45F, -4.75F, -2.0F, 4.0F, 2.0F, 5.0F, 0.0F, false);
			RightArm.setTextureOffset(94, 29).addBox(-0.05F, 8.25F, -2.5F, 6.0F, 1.0F, 6.0F, 0.0F, false);
			RightArm.setTextureOffset(26, 76).addBox(-0.05F, 9.25F, -2.5F, 7.0F, 17.0F, 6.0F, 0.0F, false);
