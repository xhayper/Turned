...
@OnlyIn(Dist.CLIENT)
public class HertxvarSolRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HertxvarSolEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelhertx_model_s1(), 0.6f) {
					{
