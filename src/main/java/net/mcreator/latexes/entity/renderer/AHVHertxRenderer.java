...
@OnlyIn(Dist.CLIENT)
public class AHVHertxRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(AHVHertxEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelAHV_hertx_model(), 0.7f) {
					{
