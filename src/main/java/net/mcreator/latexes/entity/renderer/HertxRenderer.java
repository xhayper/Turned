...
@OnlyIn(Dist.CLIENT)
public class HertxRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HertxEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelhertx_model(), 0.6f) {
					{
