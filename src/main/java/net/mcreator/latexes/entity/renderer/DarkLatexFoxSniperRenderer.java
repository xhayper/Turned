...
@OnlyIn(Dist.CLIENT)
public class DarkLatexFoxSniperRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DarkLatexFoxSniperEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeldl_fox_sniper_model(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("latex:textures/darklatexfoxsniper.png");
					}
				};
			});
		}
