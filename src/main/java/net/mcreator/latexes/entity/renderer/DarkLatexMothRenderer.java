...
@OnlyIn(Dist.CLIENT)
public class DarkLatexMothRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DarkLatexMothEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeldl_moth_model(), 0.6f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("latex:textures/dl_moth_texture.png");
					}
				};
			});
		}
