...
@OnlyIn(Dist.CLIENT)
public class SlimelingRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SlimelingEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelslimeling_model(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("latex:textures/slimeling.png");
					}
				};
			});
		}
