...
@OnlyIn(Dist.CLIENT)
public class LatexDropPodRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(LatexDropPodEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelLatex_Drop_Pod(), 1.2000000000000002f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("latex:textures/latex_drop_pod.png");
					}
				};
			});
		}
