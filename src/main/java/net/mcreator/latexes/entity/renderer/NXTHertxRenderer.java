...
@OnlyIn(Dist.CLIENT)
public class NXTHertxRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NXTHertxEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelnxt_hertx_model(), 0.6f) {
					{
