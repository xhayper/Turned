...
@OnlyIn(Dist.CLIENT)
public class NoiseStalkerRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(NoiseStalkerEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelnoisestalker_model(), 0.7999999999999999f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("latex:textures/noisestalker_texture.png");
					}
				};
			});
		}
