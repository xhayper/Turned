...
@OnlyIn(Dist.CLIENT)
public class DarkLatexSnepRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(DarkLatexSnepEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeldark_latex_snep_model(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("latex:textures/dl_snep_texture.png");
					}
				};
			});
		}
