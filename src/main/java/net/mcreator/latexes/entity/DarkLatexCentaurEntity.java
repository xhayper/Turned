...
import net.mcreator.latexes.entity.renderer.DarkLatexCentaurRenderer;
...
public class DarkLatexCentaurEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2.2f)).build("dark_latex_centaur").setRegistryName("dark_latex_centaur");
	public DarkLatexCentaurEntity(LatexModElements instance) {
		super(instance, 4);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarkLatexCentaurRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16777216, new Item.Properties().group(LatexentitiesItemGroup.tab))
				.setRegistryName("dark_latex_centaur_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(25, new RandomWalkingGoal(this, 0.7));
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				DarkLatexCentaurThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
