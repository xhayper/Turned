...
import net.mcreator.latexes.entity.renderer.HertxvarSolRenderer;
...
public class HertxvarSolEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7f, 2f)).build("hertxvar_sol").setRegistryName("hertxvar_sol");
	public HertxvarSolEntity(LatexModElements instance) {
		super(instance, 545);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HertxvarSolRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				HertxvarSolRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
