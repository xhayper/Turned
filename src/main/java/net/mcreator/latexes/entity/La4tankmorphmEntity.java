...
import net.mcreator.latexes.entity.renderer.La4tankmorphmRenderer;
import net.mcreator.latexes.LatexModElements;

@LatexModElements.ModElement.Tag
public class La4tankmorphmEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.1f, 4.199999999999999f)).build("la_4tankmorphm").setRegistryName("la_4tankmorphm");
	public La4tankmorphmEntity(LatexModElements instance) {
		super(instance, 455);
		FMLJavaModLoadingContext.get().getModEventBus().register(new La4tankmorphmRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, TSCOutsiderGunnerEntity.CustomEntity.class, true, false));
			this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, TSCOutsiderEntity.CustomEntity.class, true, false));
			this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, TSCdroneEntity.CustomEntity.class, true, false));
			...
			this.goalSelector.addGoal(36, new RandomWalkingGoal(this, 1));
			this.targetSelector.addGoal(37, new HurtByTargetGoal(this).setCallsForHelp(this.getClass()));
			this.goalSelector.addGoal(38, new LeapAtTargetGoal(this, (float) 0.5));
			this.goalSelector.addGoal(39, new LookRandomlyGoal(this));
			this.goalSelector.addGoal(40, new SwimGoal(this));
		}
