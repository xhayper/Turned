...
import net.mcreator.latexes.entity.renderer.DarklatexslugRenderer;
import net.mcreator.latexes.block.BoxInventoryBlock;
import net.mcreator.latexes.block.BoxBlock;
...
public class DarklatexslugEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7999999999999999f, 0.4f)).build("darklatexslug").setRegistryName("darklatexslug");
	public DarklatexslugEntity(LatexModElements instance) {
		super(instance, 2);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarklatexslugRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -10066330, new Item.Properties().group(LatexentitiesItemGroup.tab))
				.setRegistryName("darklatexslug_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return DarklatexslugNaturalEntitySpawningConditionProcedure.executeProcedure(ImmutableMap.of("world", world));
				});
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new AvoidEntityGoal(this, MonsterEntity.class, (float) 8, 1, 1.2));
			this.goalSelector.addGoal(3, new AvoidEntityGoal(this, AHVHertxEntity.CustomEntity.class, (float) 8, 1, 1.2));
			this.goalSelector.addGoal(4, new AvoidEntityGoal(this, PlayerEntity.class, (float) 8, 1, 1.2));
			...
			this.goalSelector.addGoal(8, new BreakBlockGoal(Blocks.CHEST, this, 1, (int) 3));
			this.goalSelector.addGoal(9, new BreakBlockGoal(BoxBlock.block, this, 1, (int) 3));
			this.goalSelector.addGoal(10, new BreakBlockGoal(BoxInventoryBlock.block, this, 1, (int) 3));
			this.goalSelector.addGoal(11, new RestrictSunGoal(this));
			this.goalSelector.addGoal(12, new ReturnToVillageGoal(this, 0.6, false));
			this.goalSelector.addGoal(13, new EatGrassGoal(this));
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Entity entity = this;
			{
				...
				DarklatexslugOnInitialEntitySpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				DarklatexslugOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
