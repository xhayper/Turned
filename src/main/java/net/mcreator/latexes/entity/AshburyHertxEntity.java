...
import net.mcreator.latexes.entity.renderer.AshburyHertxRenderer;
...
public class AshburyHertxEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7f, 2f)).build("ashbury_hertx").setRegistryName("ashbury_hertx");
	public AshburyHertxEntity(LatexModElements instance) {
		super(instance, 556);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AshburyHertxRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -13421773, -26368, new Item.Properties().group(null)).setRegistryName("ashbury_hertx_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new FollowOwnerGoal(this, 1, (float) 2, (float) 64, false));
			this.goalSelector.addGoal(6, new OpenDoorGoal(this, true));
			this.goalSelector.addGoal(7, new OpenDoorGoal(this, false));
			this.goalSelector.addGoal(8, new LookAtGoal(this, PlayerEntity.class, (float) 8));
			this.goalSelector.addGoal(9, new LookAtGoal(this, CreatureEntity.class, (float) 6));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				AshburyHertxRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			...
			if (DarklatexgooItem.block == stack.getItem())
				return true;
			if (Items.ORANGE_DYE == stack.getItem())
				return true;
			return false;
		}
	}
