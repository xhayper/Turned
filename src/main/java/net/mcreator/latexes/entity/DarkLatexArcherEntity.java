...
import net.mcreator.latexes.entity.renderer.DarkLatexArcherRenderer;
...
public class DarkLatexArcherEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("dark_latex_archer").setRegistryName("dark_latex_archer");
	public DarkLatexArcherEntity(LatexModElements instance) {
		super(instance, 5);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarkLatexArcherRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16777216, new Item.Properties().group(LatexentitiesItemGroup.tab))
				.setRegistryName("dark_latex_archer_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 5;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(CrystalbowItem.block));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(DarkLatexQuiverItem.body));
		}
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(13, new NearestAttackableTargetGoal(this, AHVHertxEntity.CustomEntity.class, true, false));
			this.targetSelector.addGoal(14, new NearestAttackableTargetGoal(this, AshburyHertxEntity.CustomEntity.class, true, false));
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			CrystalbowItem.shoot(this, target);
		}
	}
}
