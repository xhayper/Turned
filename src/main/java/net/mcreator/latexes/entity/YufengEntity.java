...
import net.mcreator.latexes.entity.renderer.YufengRenderer;
...
public class YufengEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.9f)).build("yufeng").setRegistryName("yufeng");
	public YufengEntity(LatexModElements instance) {
		super(instance, 7);
		FMLJavaModLoadingContext.get().getModEventBus().register(new YufengRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -15987700, new Item.Properties().group(LatexentitiesItemGroup.tab))
				.setRegistryName("yufeng_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 8;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(YufengbodyItem.body));
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(18, new NearestAttackableTargetGoal(this, SkeletonEntity.class, true, false));
			this.targetSelector.addGoal(19, new NearestAttackableTargetGoal(this, ZombieEntity.class, true, false));
			this.targetSelector.addGoal(20, new NearestAttackableTargetGoal(this, ZombieVillagerEntity.class, true, false));
			this.targetSelector.addGoal(21, new NearestAttackableTargetGoal(this, PiglinEntity.class, true, false));
			this.targetSelector.addGoal(22, new NearestAttackableTargetGoal(this, PiglinBruteEntity.class, true, false));
			this.targetSelector.addGoal(23, new NearestAttackableTargetGoal(this, ZoglinEntity.class, true, false));
			this.goalSelector.addGoal(24, new WaterAvoidingRandomWalkingGoal(this, 0.8));
			this.goalSelector.addGoal(25, new RandomWalkingGoal(this, 0.8, 20) {
				@Override
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				YufengThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
