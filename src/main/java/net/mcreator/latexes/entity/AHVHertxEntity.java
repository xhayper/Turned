...
import net.mcreator.latexes.entity.renderer.AHVHertxRenderer;
...
public class AHVHertxEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7f, 2f)).build("ahv_hertx").setRegistryName("ahv_hertx");
	public AHVHertxEntity(LatexModElements instance) {
		super(instance, 437);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AHVHertxRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -14274520, -15794418, new Item.Properties().group(null)).setRegistryName("ahv_hertx_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new FollowOwnerGoal(this, 1, (float) 2, (float) 48, false));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(HertxvisorItem.block));
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				AHVHertxRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
