...
import net.mcreator.latexes.entity.renderer.DarkLatexSpiderRenderer;
...
public class DarkLatexSpiderEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.7999999999999999f, 2f)).build("dark_latex_spider").setRegistryName("dark_latex_spider");
	public DarkLatexSpiderEntity(LatexModElements instance) {
		super(instance, 18);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarkLatexSpiderRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -13434880, new Item.Properties().group(LatexentitiesItemGroup.tab))
				.setRegistryName("dark_latex_spider_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, MilitaryRiotEntity.CustomEntity.class, true, false));
			...
			this.targetSelector.addGoal(17, new NearestAttackableTargetGoal(this, AHVHertxEntity.CustomEntity.class, true, false));
			this.targetSelector.addGoal(18, new NearestAttackableTargetGoal(this, BeeEntity.class, true, false));
			this.targetSelector.addGoal(19, new NearestAttackableTargetGoal(this, DLbeeEntity.CustomEntity.class, true, false));
			...
			this.targetSelector.addGoal(21, new NearestAttackableTargetGoal(this, FoxEntity.class, true, false));
			this.targetSelector.addGoal(22, new NearestAttackableTargetGoal(this, AHVHertxEntity.CustomEntity.class, true, false));
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				DarkLatexSpiderThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				DarkLatexSpiderOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
