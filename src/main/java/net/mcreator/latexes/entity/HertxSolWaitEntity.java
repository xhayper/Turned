...
import net.mcreator.latexes.entity.renderer.HertxSolWaitRenderer;
...
public class HertxSolWaitEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7f, 2f)).build("hertx_sol_wait").setRegistryName("hertx_sol_wait");
	public HertxSolWaitEntity(LatexModElements instance) {
		super(instance, 575);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HertxSolWaitRenderer.ModelRegisterHandler());
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 7.5);
	...
	public static class CustomEntity extends TameableEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				HertxSolWaitEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				HertxSolWaitRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			...
			if (Items.IRON_NUGGET == stack.getItem())
				return true;
			if (Items.IRON_INGOT == stack.getItem())
				return true;
			return false;
		}
	}
