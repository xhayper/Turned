...
import net.mcreator.latexes.entity.renderer.DarkLatexFoxScientistRenderer;
...
public class DarkLatexFoxScientistEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("dark_latex_fox_scientist").setRegistryName("dark_latex_fox_scientist");
	public DarkLatexFoxScientistEntity(LatexModElements instance) {
		super(instance, 403);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarkLatexFoxScientistRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16777165, new Item.Properties().group(null))
				.setRegistryName("dark_latex_fox_scientist_spawn_egg"));
	}
