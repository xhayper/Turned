...
import net.mcreator.latexes.entity.renderer.HertxSitRenderer;
...
public class HertxSitEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7999999999999999f, 1.2000000000000002f)).build("hertx_sit").setRegistryName("hertx_sit");
	public HertxSitEntity(LatexModElements instance) {
		super(instance, 554);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HertxSitRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				HertxSitRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
