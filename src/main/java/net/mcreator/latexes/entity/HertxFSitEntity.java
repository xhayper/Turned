...
import net.mcreator.latexes.entity.renderer.HertxFSitRenderer;
...
public class HertxFSitEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7999999999999999f, 1.2000000000000002f)).build("hertx_f_sit").setRegistryName("hertx_f_sit");
	public HertxFSitEntity(LatexModElements instance) {
		super(instance, 569);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HertxFSitRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 4;
			setNoAI(false);
			setCustomName(new StringTextComponent("§b[Idle]"));
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new LookAtGoal(this, DarklatexEntity.CustomEntity.class, (float) 3));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				HertxFSitRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
