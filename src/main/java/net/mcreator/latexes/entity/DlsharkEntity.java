...
import net.mcreator.latexes.entity.renderer.DlsharkRenderer;
...
public class DlsharkEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("dlshark").setRegistryName("dlshark");
	public DlsharkEntity(LatexModElements instance) {
		super(instance, 10);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DlsharkRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16777216, new Item.Properties().group(LatexentitiesItemGroup.tab))
				.setRegistryName("dlshark_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(21, new NearestAttackableTargetGoal(this, CodEntity.class, true, false));
			...
			this.goalSelector.addGoal(24, new RandomWalkingGoal(this, 0.8));
			...
			this.goalSelector.addGoal(26, new SwimGoal(this) {
				...
				public boolean shouldExecute() {
					...
					return super.shouldExecute()
							&& CheckbordersharkProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
				}
			});
		}
