...
import net.mcreator.latexes.entity.renderer.DarkLatexFoxSniperRenderer;
...
public class DarkLatexFoxSniperEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.9f)).build("dark_latex_fox_sniper").setRegistryName("dark_latex_fox_sniper");
	public DarkLatexFoxSniperEntity(LatexModElements instance) {
		super(instance, 15);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarkLatexFoxSniperRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16769758, new Item.Properties().group(LatexentitiesItemGroup.tab))
				.setRegistryName("dark_latex_fox_sniper_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				DarkLatexFoxThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}

		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			LatexDartRifleItem.shoot(this, target);
		}
	}
}
