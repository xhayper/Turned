...
import net.mcreator.latexes.entity.renderer.DarkLatexSpiderQueenRenderer;
...
public class DarkLatexSpiderQueenEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.2f, 3.6f)).build("dark_latex_spider_queen").setRegistryName("dark_latex_spider_queen");
	public DarkLatexSpiderQueenEntity(LatexModElements instance) {
		super(instance, 21);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarkLatexSpiderQueenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -6750208, new Item.Properties().group(LatexentitiesItemGroup.tab))
				.setRegistryName("dark_latex_spider_queen_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				DarkLatexSpiderQueenEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				DarkLatexSpiderQueenThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
