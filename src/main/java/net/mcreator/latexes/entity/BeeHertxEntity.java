...
import net.mcreator.latexes.entity.renderer.BeeHertxRenderer;
...
public class BeeHertxEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 2.3f)).build("bee_hertx").setRegistryName("bee_hertx");
	public BeeHertxEntity(LatexModElements instance) {
		super(instance, 415);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BeeHertxRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new FollowOwnerGoal(this, 1, (float) 1, (float) 36, false));
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				BeeHertxEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BeeHertxRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BeeHertxThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
