...
import net.mcreator.latexes.entity.renderer.HertxvarFRenderer;
...
public class HertxvarFEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(96).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.7f, 2f))
					.build("hertxvar_f").setRegistryName("hertxvar_f");
	public HertxvarFEntity(LatexModElements instance) {
		super(instance, 544);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HertxvarFRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				HertxvarFRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
