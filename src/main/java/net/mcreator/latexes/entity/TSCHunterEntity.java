...
import net.mcreator.latexes.entity.renderer.TSCHunterRenderer;
...
public class TSCHunterEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7000000000000001f, 2.5f)).build("tsc_hunter").setRegistryName("tsc_hunter");
	public TSCHunterEntity(LatexModElements instance) {
		super(instance, 32);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TSCHunterRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -65536, new Item.Properties().group(LatexentitiesItemGroup.tab))
				.setRegistryName("tsc_hunter_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new BreakBlockGoal(DarklatexblockBlock.block, this, 1, (int) 3));
			this.goalSelector.addGoal(6, new BreakBlockGoal(DarklatexblockharmlessBlock.block, this, 1, (int) 3));
			this.goalSelector.addGoal(7, new BreakBlockGoal(DarklatexblockcrystalgrowBlock.block, this, 1, (int) 3));
			this.goalSelector.addGoal(8, new BreakBlockGoal(DarklatexhiveBlock.block, this, 1, (int) 3));
			...
			this.targetSelector.addGoal(38, new NearestAttackableTargetGoal(this, DarklatexEntity.CustomEntity.class, true, false));
			...
			this.targetSelector.addGoal(44, new NearestAttackableTargetGoal(this, WitchEntity.class, true, false));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				TSCHunterEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			Entity sourceentity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				TSCHunterThisEntityKillsAnotherOneProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
