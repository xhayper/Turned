...
import net.mcreator.latexes.entity.renderer.BeeHertxSitRenderer;
...
public class BeeHertxSitEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7999999999999999f, 1.2000000000000002f)).build("bee_hertx_sit").setRegistryName("bee_hertx_sit");
	public BeeHertxSitEntity(LatexModElements instance) {
		super(instance, 560);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BeeHertxSitRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 4;
			setNoAI(false);
			setCustomName(new StringTextComponent("§e[Idle]"));
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new LookAtGoal(this, PlayerEntity.class, (float) 3));
			this.goalSelector.addGoal(3, new LookAtGoal(this, CreatureEntity.class, (float) 6));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				BeeHertxSitRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			...
			if (Items.HONEYCOMB == stack.getItem())
				return true;
			if (Items.HONEY_BOTTLE == stack.getItem())
				return true;
