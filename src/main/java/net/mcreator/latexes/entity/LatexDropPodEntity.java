...
import net.mcreator.latexes.entity.renderer.LatexDropPodRenderer;
...
public class LatexDropPodEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.2f, 2.2f)).build("latex_drop_pod").setRegistryName("latex_drop_pod");
	public LatexDropPodEntity(LatexModElements instance) {
		super(instance, 492);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LatexDropPodRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				LatexDropPodOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
