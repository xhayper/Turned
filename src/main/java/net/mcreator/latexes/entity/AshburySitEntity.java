...
import net.mcreator.latexes.entity.renderer.AshburySitRenderer;
...
public class AshburySitEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7999999999999999f, 1.2000000000000002f)).build("ashbury_sit").setRegistryName("ashbury_sit");
	public AshburySitEntity(LatexModElements instance) {
		super(instance, 557);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AshburySitRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 4;
			setNoAI(false);
			setCustomName(new StringTextComponent("§6[Idle]"));
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new LookAtGoal(this, PlayerEntity.class, (float) 5));
			this.goalSelector.addGoal(3, new LookAtGoal(this, CreatureEntity.class, (float) 3));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				AshburySitRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
