...
import net.mcreator.latexes.entity.renderer.AHVHertxSitRenderer;
...
public class AHVHertxSitEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7999999999999999f, 1.2000000000000002f)).build("ahv_hertx_sit").setRegistryName("ahv_hertx_sit");
	public AHVHertxSitEntity(LatexModElements instance) {
		super(instance, 563);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AHVHertxSitRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 4;
			setNoAI(false);
			setCustomName(new StringTextComponent("§a[Idle]"));
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new LookAtGoal(this, DarklatexEntity.CustomEntity.class, (float) 3));
			this.goalSelector.addGoal(4, new LookAtGoal(this, CreatureEntity.class, (float) 3));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				AHVHertxSitRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
