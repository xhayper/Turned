...
import net.mcreator.latexes.entity.renderer.NXTSitRenderer;
...
public class NXTSitEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7999999999999999f, 1.2000000000000002f)).build("nxt_sit").setRegistryName("nxt_sit");
	public NXTSitEntity(LatexModElements instance) {
		super(instance, 567);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NXTSitRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 4;
			setNoAI(false);
			setCustomName(new StringTextComponent("§c[Idle]"));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				NXTSitRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (Items.REDSTONE == stack.getItem())
				return true;
