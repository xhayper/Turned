...
import net.mcreator.latexes.entity.renderer.HertxFBSitRenderer;
...
public class HertxFBSitEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7999999999999999f, 1.5f)).build("hertx_fb_sit").setRegistryName("hertx_fb_sit");
	public HertxFBSitEntity(LatexModElements instance) {
		super(instance, 572);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HertxFBSitRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 4;
			setNoAI(false);
			setCustomName(new StringTextComponent("§3[Idle]"));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				HertxFBSitRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
