...
import net.mcreator.latexes.entity.renderer.NXTHertxRenderer;
...
public class NXTHertxEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7f, 2f)).build("nxt_hertx").setRegistryName("nxt_hertx");
	public NXTHertxEntity(LatexModElements instance) {
		super(instance, 459);
		FMLJavaModLoadingContext.get().getModEventBus().register(new NXTHertxRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -13421773, -6750208, new Item.Properties().group(null)).setRegistryName("nxt_hertx_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(8, new LookAtGoal(this, DarklatexEntity.CustomEntity.class, (float) 6));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				NXTHertxRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
