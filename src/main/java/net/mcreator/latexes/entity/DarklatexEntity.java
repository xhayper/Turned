...
import net.mcreator.latexes.entity.renderer.DarklatexRenderer;
...
public class DarklatexEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("darklatex").setRegistryName("darklatex");
	public DarklatexEntity(LatexModElements instance) {
		super(instance, 3);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DarklatexRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16777216, new Item.Properties().group(LatexentitiesItemGroup.tab))
				.setRegistryName("darklatex_spawn_egg"));
	}
