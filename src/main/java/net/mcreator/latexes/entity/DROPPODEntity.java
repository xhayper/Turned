...
import net.mcreator.latexes.entity.renderer.DROPPODRenderer;
...
public class DROPPODEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.2f, 2.2f)).build("droppod").setRegistryName("droppod");
	public DROPPODEntity(LatexModElements instance) {
		super(instance, 464);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DROPPODRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				DROPPODOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
