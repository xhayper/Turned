...
import net.mcreator.latexes.entity.renderer.HertxvarFBRenderer;
...
public class HertxvarFBEntity extends LatexModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7f, 2.1f)).build("hertxvar_fb").setRegistryName("hertxvar_fb");
	public HertxvarFBEntity(LatexModElements instance) {
		super(instance, 546);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HertxvarFBRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new FollowOwnerGoal(this, 1, (float) 3, (float) 64, false));
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				HertxvarFBRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
