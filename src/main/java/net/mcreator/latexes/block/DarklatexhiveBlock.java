...
public class DarklatexhiveBlock extends LatexModElements.ModElement {
	@ObjectHolder("latex:darklatexhive")
	public static final Block block = null;
	public DarklatexhiveBlock(LatexModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.SLIME).hardnessAndResistance(0.75f, 5f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool().slipperiness(0.3f).speedFactor(0.6f).jumpFactor(0.6f)
					.tickRandomly());
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH));
			setRegistryName("darklatexhive");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				DarklatexhiveUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				DarklatexhiveBlockDestroyedByExplosionProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
