...
public class RedLabStairsBlock extends LatexModElements.ModElement {
	@ObjectHolder("latex:red_lab_stairs")
	public static final Block block = null;
	public RedLabStairsBlock(LatexModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("red_lab_stairs");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Variant C"));
		}
