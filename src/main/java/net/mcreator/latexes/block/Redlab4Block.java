...
public class Redlab4Block extends LatexModElements.ModElement {
	@ObjectHolder("latex:redlab_4")
	public static final Block block = null;
	public Redlab4Block(LatexModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Base Variant"));
		}
