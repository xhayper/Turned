...
public class Redlab1Block extends LatexModElements.ModElement {
	@ObjectHolder("latex:redlab_1")
	public static final Block block = null;
	public Redlab1Block(LatexModElements instance) {
		super(instance, 104);
	}
