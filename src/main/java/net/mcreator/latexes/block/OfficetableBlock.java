...
public class OfficetableBlock extends LatexModElements.ModElement {
	@ObjectHolder("latex:officetable")
	public static final Block block = null;
	public OfficetableBlock(LatexModElements instance) {
		super(instance, 147);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(16, 0, 16, -16, 16, 0)).withOffset(offset.x, offset.y, offset.z);
				case NORTH :
