...
public class NukeBlock extends LatexModElements.ModElement {
	@ObjectHolder("latex:nuke")
	public static final Block block = null;
	public NukeBlock(LatexModElements instance) {
		super(instance, 302);
	}
	...
	public static class CustomBlock extends Block {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				{
					...
					NukeOnBlockRightClickedProcedure.executeProcedure($_dependencies);
				}
			} else {
			}
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				NukeBlockDestroyedByExplosionProcedure.executeProcedure($_dependencies);
			}
		}
