...
public class Redlab2Block extends LatexModElements.ModElement {
	@ObjectHolder("latex:redlab_2")
	public static final Block block = null;
	public Redlab2Block(LatexModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Variant 2C"));
		}
