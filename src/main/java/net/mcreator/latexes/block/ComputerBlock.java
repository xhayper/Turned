...
public class ComputerBlock extends LatexModElements.ModElement {
	@ObjectHolder("latex:computer")
	public static final Block block = null;
	public ComputerBlock(LatexModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ANVIL).sound(SoundType.METAL).hardnessAndResistance(1.25f, 12f).setLightLevel(s -> 0)
