...
public class ControlpaneloffBlock extends LatexModElements.ModElement {
	@ObjectHolder("latex:controlpaneloff")
	public static final Block block = null;
	public ControlpaneloffBlock(LatexModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("controlpaneloff");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				ControlpaneloffOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
