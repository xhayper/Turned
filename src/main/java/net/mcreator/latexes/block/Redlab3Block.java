...
public class Redlab3Block extends LatexModElements.ModElement {
	@ObjectHolder("latex:redlab_3")
	public static final Block block = null;
	public Redlab3Block(LatexModElements instance) {
		super(instance, 106);
	}
