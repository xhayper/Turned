...
public class EvilBeaconBlock extends LatexModElements.ModElement {
	@ObjectHolder("latex:evil_beacon")
	public static final Block block = null;
	public EvilBeaconBlock(LatexModElements instance) {
		super(instance, 167);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
			{
				...
				EvilBeaconOffUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
