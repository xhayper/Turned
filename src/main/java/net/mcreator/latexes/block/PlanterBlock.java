...
public class PlanterBlock extends LatexModElements.ModElement {
	@ObjectHolder("latex:planter")
	public static final Block block = null;
	public PlanterBlock(LatexModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.WOOD).hardnessAndResistance(0.75f, 6.5f).setLightLevel(s -> 0)
