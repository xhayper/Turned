...
public class BunkerWallBlock extends LatexModElements.ModElement {
	@ObjectHolder("latex:bunker_wall")
	public static final Block block = null;
	public BunkerWallBlock(LatexModElements instance) {
		super(instance, 116);
	}
