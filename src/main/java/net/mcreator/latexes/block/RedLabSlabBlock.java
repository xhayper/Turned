...
public class RedLabSlabBlock extends LatexModElements.ModElement {
	@ObjectHolder("latex:red_lab_slab")
	public static final Block block = null;
	public RedLabSlabBlock(LatexModElements instance) {
		super(instance, 109);
	}
