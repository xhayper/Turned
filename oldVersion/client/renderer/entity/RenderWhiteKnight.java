...
public class RenderWhiteKnight extends RenderLiving<EntityWhiteKnight> {
    ...
    public RenderWhiteKnight(RenderManager manager) { super(manager, new ModelWhiteKnight(), 0.5F); }
    ...
    @Override
    protected void applyRotations(EntityWhiteKnight entityLiving, float p_77043_2_, float rotationYaw, float partialTicks) {
